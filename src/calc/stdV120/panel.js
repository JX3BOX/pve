...
function CalcStrain(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelStrain = AddAndMultiply(GetAttr(attrs, "atStrainBase"), GetAttr(attrs, "atPVXAllRound"), GetAttr(attrs, "atStrainPercent"));
...
function CalcSurplusValue(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelSurplusValue = AddAndMultiply(GetAttr(attrs, "atSurplusValueBase"), GetAttr(attrs, "atPVXAllRound"), GetAttr(attrs, "atSurplusValueAddPercent"));
...
function CalcDecriticalDamage(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelDecritical = AddAndMultiply(GetAttr(attrs, "atDecriticalDamagePowerBase"), GetAttr(attrs, "atPVXAllRound"), GetAttr(attrs, "atDecriticalDamagePowerPercent"));
...
function CalcPVXAllRound(attrs, panelAttrs, finalAttrs) {
    ...
    AddAttribute(panelAttrs, "PVXAllRoundtoSurplusValue", atPVXAllRound);
    AddAttribute(panelAttrs, "PVXAllRoundtoStrain", atPVXAllRound);
