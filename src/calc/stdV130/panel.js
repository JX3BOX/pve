...
export function GetPanel(attrs) {
    ...
    CalcPVXAllRound(attrs, panelAttrs, finalAttrs);
...
function CalcVitality(attrs, panelAttrs, finalAttrs) {
    //console.log(`--->体质<---`);
    let atPanelFinalVitality = AddAndMultiply(
        GetAttr(attrs, "atBasePotentialAdd"),
        GetAttr(attrs, "atVitalityBase"),
        GetAttr(attrs, "atVitalityBasePercentAdd")
    );
    ...
    let atPanelMaxHealthFinal =
        AddAndMultiply(
            AddAndMultiply(atPanelMaxHealthBase, 0, GetAttr(attrs, "atMaxLifePercentAdd")),
            GetAttr(attrs, "atMaxLifeAdditional"),
            GetAttr(attrs, "atFinalMaxLifeAddPercent")
...
function CalcAgility(attrs, panelAttrs, finalAttrs) {
    //console.log(`--->身法<---`);
    let atAgility = AddAndMultiply(
        GetAttr(attrs, "atBasePotentialAdd"),
        GetAttr(attrs, "atAgilityBase"),
        GetAttr(attrs, "atAgilityBasePercentAdd")
    );
...
function CalcSpirit(attrs, panelAttrs, finalAttrs) {
    //console.log(`--->根骨<---`);
    let atSpirit = AddAndMultiply(
        GetAttr(attrs, "atBasePotentialAdd"),
        GetAttr(attrs, "atSpiritBase"),
        GetAttr(attrs, "atSpiritBasePercentAdd")
    );
...
function CalcSpunk(attrs, panelAttrs, finalAttrs) {
    //console.log(`--->元气<---`);
    let atSpunk = AddAndMultiply(
        GetAttr(attrs, "atBasePotentialAdd"),
        GetAttr(attrs, "atSpunkBase"),
        GetAttr(attrs, "atSpunkBasePercentAdd")
    );
...
function CalcStrength(attrs, panelAttrs, finalAttrs) {
    //console.log(`--->力道<---`);
    let atStrength = AddAndMultiply(
        GetAttr(attrs, "atBasePotentialAdd"),
        GetAttr(attrs, "atStrengthBase"),
        GetAttr(attrs, "atStrengthBasePercentAdd")
    );
...
function CalcAttackPower(attrs, panelAttrs, finalAttrs) {
    ...
    const basePhysicsAPWithPercent = AddAndMultiply(
        atPanelPhysicsAttackPowerBase,
        0,
        GetAttr(attrs, "atPhysicsAttackPowerPercent")
    );
    ...
    const baseLunarAPWithPercent = AddAndMultiply(
        atPanelLunarAttackPowerBase,
        0,
        GetAttr(attrs, "atLunarAttackPowerPercent")
    );
    ...
    const baseSolarAPWithPercent = AddAndMultiply(
        atPanelSolarAttackPowerBase,
        0,
        GetAttr(attrs, "atSolarAttackPowerPercent")
    );
    ...
    const baseNeutralAPWithPercent = AddAndMultiply(
        atPanelNeutralAttackPowerBase,
        0,
        GetAttr(attrs, "atNeutralAttackPowerPercent")
    );
    ...
    const basePoisonAPWithPercent = AddAndMultiply(
        atPanelPoisonAttackPowerBase,
        0,
        GetAttr(attrs, "atPoisonAttackPowerPercent")
    );
...
function CalcTherapyPower(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelTherapyPowerBase = GetAttr(attrs, "atTherapyPowerBase");
    AddAttribute(panelAttrs, "TherapyPowerBase", atPanelTherapyPowerBase);
    //console.log(`基础治疗：${atPanelTherapyPowerBase}`);
    const baseTherapyWithPercent = AddAndMultiply(atPanelTherapyPowerBase, 0, GetAttr(attrs, "atTherapyPowerPercent"));
...
function CalcCriticalStrike(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelPhysicsCriticalStrikePercent =
        atPhysicsCriticalStrikeRate / (levelConst.fCriticalStrikeParam * levelConst.nLevelCoefficient) +
        GetAttr(attrs, "atPhysicsCriticalStrikeBaseRate") / 10000;
    ...
    let atPanelLunarCriticalStrikePercent =
        atPanelLunarCriticalStrike / (levelConst.fCriticalStrikeParam * levelConst.nLevelCoefficient) +
        GetAttr(attrs, "atLunarCriticalStrikeBaseRate") / 10000;
    ...
    let atPanelSolarCriticalStrikePercent =
        atPanelSolarCriticalStrike / (levelConst.fCriticalStrikeParam * levelConst.nLevelCoefficient) +
        GetAttr(attrs, "atSolarCriticalStrikeBaseRate") / 10000;
    ...
    let atPanelNeutralCriticalStrikePercent =
        atPanelNeutralCriticalStrike / (levelConst.fCriticalStrikeParam * levelConst.nLevelCoefficient) +
        GetAttr(attrs, "atNeutralCriticalStrikeBaseRate") / 10000;
    ...
    let atPanelPoisonCriticalStrikePercent =
        atPanelPoisonCriticalStrike / (levelConst.fCriticalStrikeParam * levelConst.nLevelCoefficient) +
        GetAttr(attrs, "atPoisonCriticalStrikeBaseRate") / 10000;
...
function CalcCriticalDamagePower(attrs, panelAttrs, finalAttrs) {
    ...
    let atPhysicsCriticalDamagePowerPercentWithoutKiloBase = AddAndMultiply(
        atPanelPhysicsCriticalDamagePower,
        0,
        GetAttr(attrs, "atPhysicsCriticalDamagePowerPercent")
    );
    let atPhysicsCriticalDamagePowerPercent = AddAndMultiplyByKilo(
        atPhysicsCriticalDamagePowerPercentWithoutKiloBase,
        0,
        GetAttr(attrs, "atPhysicsCriticalDamagePowerBaseKiloNumRate")
    );
    let atPanelPhysicsCriticalDamagePowerPercent =
        levelConst.fPlayerCriticalCof +
        1 +
        atPhysicsCriticalDamagePowerPercent / (levelConst.fCriticalStrikePowerParam * levelConst.nLevelCoefficient);
    ...
    let atLunarCriticalDamagePowerPercentWithoutKiloBase = AddAndMultiply(
        atPanelLunarCriticalDamagePower,
        0,
        GetAttr(attrs, "atLunarCriticalDamagePowerPercent")
    );
    let atLunarCriticalDamagePowerPercent = AddAndMultiplyByKilo(
        atLunarCriticalDamagePowerPercentWithoutKiloBase,
        0,
        GetAttr(attrs, "atLunarCriticalDamagePowerBaseKiloNumRate")
    );
    ...
    let atSolarCriticalDamagePowerPercentWithoutKiloBase = AddAndMultiply(
        atPanelSolarCriticalDamagePower,
        0,
        GetAttr(attrs, "atSolarCriticalDamagePowerPercent")
    );
    let atSolarCriticalDamagePowerPercent = AddAndMultiplyByKilo(
        atSolarCriticalDamagePowerPercentWithoutKiloBase,
        0,
        GetAttr(attrs, "atSolarCriticalDamagePowerBaseKiloNumRate")
    );
    ...
    let atNeutralCriticalDamagePowerPercentWithoutKiloBase = AddAndMultiply(
        atPanelNeutralCriticalDamagePower,
        0,
        GetAttr(attrs, "atNeutralCriticalDamagePowerPercent")
    );
    let atNeutralCriticalDamagePowerPercent = AddAndMultiplyByKilo(
        atNeutralCriticalDamagePowerPercentWithoutKiloBase,
        0,
        GetAttr(attrs, "atNeutralCriticalDamagePowerBaseKiloNumRate")
    );
    ...
    let atPoisonCriticalDamagePowerPercentWithoutKiloBase = AddAndMultiply(
        atPanelPoisonCriticalDamagePower,
        0,
        GetAttr(attrs, "atPoisonCriticalDamagePowerPercent")
    );
    let atPoisonCriticalDamagePowerPercent = AddAndMultiplyByKilo(
        atPoisonCriticalDamagePowerPercentWithoutKiloBase,
        0,
        GetAttr(attrs, "atPoisonCriticalDamagePowerBaseKiloNumRate")
    );
...
function CalcOvercome(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelPhysicsOvercomePercent =
        AddAndMultiply(atPanelPhysicsOvercome, 0, GetAttr(attrs, "atPhysicsOvercomePercent")) /
        (levelConst.fOvercomeParam * levelConst.nLevelCoefficient);
    ...
    let atPanelLunarOvercome =
        atPanelLunarOvercomeBase + GetAttributeConvert(finalAttrs, "atVitality", attrs, "atVitalityToMagicOverComeCof");
    AddAttribute(panelAttrs, "LunarOvercome", atPanelLunarOvercome);
    //console.log(`阴性破防等级：${atPanelLunarOvercome}`);
    let atPanelLunarOvercomePercent =
        AddAndMultiply(atPanelLunarOvercome, 0, GetAttr(attrs, "atLunarOvercomePercent")) /
        (levelConst.fOvercomeParam * levelConst.nLevelCoefficient);
    ...
    let atPanelSolarOvercome =
        atPanelSolarOvercomeBase + GetAttributeConvert(finalAttrs, "atVitality", attrs, "atVitalityToMagicOverComeCof");
    AddAttribute(panelAttrs, "SolarOvercome", atPanelSolarOvercome);
    //console.log(`阳性破防等级：${atPanelSolarOvercome}`);
    let atPanelSolarOvercomePercent =
        AddAndMultiply(atPanelSolarOvercome, 0, GetAttr(attrs, "atSolarOvercomePercent")) /
        (levelConst.fOvercomeParam * levelConst.nLevelCoefficient);
    ...
    let atPanelNeutralOvercomePercent =
        AddAndMultiply(atPanelNeutralOvercome, 0, GetAttr(attrs, "atNeutralOvercomePercent")) /
        (levelConst.fOvercomeParam * levelConst.nLevelCoefficient);
    ...
    let atPanelPoisonOvercomePercent =
        AddAndMultiply(atPanelPoisonOvercome, 0, GetAttr(attrs, "atPoisonOvercomePercent")) /
        (levelConst.fOvercomeParam * levelConst.nLevelCoefficient);
...
function CalcHaste(attrs, panelAttrs, finalAttrs) {
    ...
    let atBaseHastePercent =
        atPanelHaste / (levelConst.fHasteRate * levelConst.nLevelCoefficient) +
        GetAttr(attrs, "atHasteBasePercentAdd") / 1024;
    AddAttribute(panelAttrs, "BaseHastePercent", atBaseHastePercent);
    // console.log(`基础加速率：${atBaseHastePercent}`);
    let atPanelHastePercent = Math.floor(atBaseHastePercent * 1024) / 1024;
    // console.log(`最终加速率：${atPanelHastePercent}`);
    AddAttribute(panelAttrs, "HastePercent", atPanelHastePercent);
    AddAttribute(panelAttrs, "HasteForAttackPercent", atPanelHastePercent);

    let atFinelChannelTimePercent = 1 - 1 / (1 + Math.max(Math.floor(atPanelHastePercent * 1024) / 1024));
    AddAttribute(panelAttrs, "FinelChannelTimePercent", atFinelChannelTimePercent);
    // 这里前端限制字段名要存在"percent"才能识别为百分比数值
...
function CalcStrain(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelStrain = AddAndMultiply(
        GetAttr(attrs, "atStrainBase"),
        Math.floor((GetAttr(attrs, "atPVXAllRound") * 3) / 2),
        GetAttr(attrs, "atStrainPercent")
    );
    //console.log(`无双等级：${atPanelStrain}`);
    AddAttribute(panelAttrs, "Strain", atPanelStrain);
    let atPanelStrainPercent =
        atPanelStrain / (levelConst.fInsightParam * levelConst.nLevelCoefficient) + GetAttr(attrs, "atStrainRate");
...
function CalcSurplusValue(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelSurplusValue = AddAndMultiply(
        GetAttr(attrs, "atSurplusValueBase"),
        Math.floor(GetAttr(attrs, "atPVXAllRound") / 2),
        GetAttr(attrs, "atSurplusValueAddPercent")
    );
...
function CalcPhysicsShield(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelPhysicsShieldBase = GetAttr(attrs, "atPhysicsShieldBase");
    ...
    let atPanelPhysicsShieldFinalPercent =
        atPanelPhysicsShieldFinal /
        (atPanelPhysicsShieldFinal + levelConst.fPhysicsShieldParam * levelConst.nLevelCoefficient);
...
function CalcMagicShield(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelLunarShieldBase = GetAttr(attrs, "atMagicShield") + GetAttr(attrs, "atLunarMagicShieldBase");
    ...
    let atPanelLunarShieldFinalPercent =
        atPanelLunarShieldFinal /
        (atPanelLunarShieldFinal + levelConst.fMagicShieldParam * levelConst.nLevelCoefficient);
    ...
    let atPanelSolarShieldBase = GetAttr(attrs, "atMagicShield") + GetAttr(attrs, "atSolarMagicShieldBase");
    ...
    let atPanelSolarShieldFinalPercent =
        atPanelSolarShieldFinal /
        (atPanelSolarShieldFinal + levelConst.fMagicShieldParam * levelConst.nLevelCoefficient);
    ...
    let atPanelNeutralShieldBase = GetAttr(attrs, "atMagicShield") + GetAttr(attrs, "atNeutralMagicShieldBase");
    ...
    let atPanelNeutralShieldFinalPercent =
        atPanelNeutralShieldFinal /
        (atPanelNeutralShieldFinal + levelConst.fMagicShieldParam * levelConst.nLevelCoefficient);
    ...
    let atPanelPoisonShieldBase = GetAttr(attrs, "atMagicShield") + GetAttr(attrs, "atPoisonMagicShieldBase");
    ...
    let atPanelPoisonShieldFinalPercent =
        atPanelPoisonShieldFinal /
        (atPanelPoisonShieldFinal + levelConst.fMagicShieldParam * levelConst.nLevelCoefficient);
...
function CalcDodge(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelDodgePercent =
        atPanelDodge / (atPanelDodge + levelConst.fDodgeParam * levelConst.nLevelCoefficient) +
        GetAttr(attrs, "atDodgeBaseRate") / 10000;
...
function CalcParry(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelParryPercent =
        atPanelParry / (atPanelParry + levelConst.fParryParam * levelConst.nLevelCoefficient) +
        GetAttr(attrs, "atParryBaseRate") / 10000 +
        0.03;
...
function CalcToughness(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelToughnessWithKilo = AddAndMultiplyByKilo(
        GetAttr(attrs, "atToughnessBase"),
        0,
        GetAttr(attrs, "atToughnessBaseRate")
    );
    ...
    let atToughnessDefCriticalPercent =
        atPanelToughness / (levelConst.fDefCriticalStrikeParam * levelConst.nLevelCoefficient);
    ...
    let atToughnessDecirDamagePercent =
        atPanelToughness / (levelConst.fToughnessDecirDamageCof * levelConst.nLevelCoefficient);
...
function CalcDecriticalDamage(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelDecritical = AddAndMultiply(
        GetAttr(attrs, "atDecriticalDamagePowerBase"),
        GetAttr(attrs, "atPVXAllRound"),
        GetAttr(attrs, "atDecriticalDamagePowerPercent")
    );
    ...
    let atDecriticalPercent =
        atPanelDecritical /
            (levelConst.fDecriticalStrikePowerParam * levelConst.nLevelCoefficient + atPanelDecritical) +
        GetAttr(attrs, "atDecriticalDamagePowerBaseKiloNumRate") / 1024;
    AddAttribute(panelAttrs, "DecriticalDamagePercent", atDecriticalPercent);
    //console.log(`化劲百分比：${atDecriticalPercent}`);
}

function CalcPVXAllRound(attrs, panelAttrs, finalAttrs) {
    //console.log(`--->全能<---`);

    let atPVXAllRound = GetAttr(attrs, "atPVXAllRound");
    AddAttribute(panelAttrs, "PVXAllRound", atPVXAllRound);
    // 全能转破招/无双/化劲，新增一个节点用于展示POP面板，计算还是取原始值
    AddAttribute(panelAttrs, "PVXAllRoundtoSurplusValue", Math.floor(atPVXAllRound / 2));
    AddAttribute(panelAttrs, "PVXAllRoundtoStrain", Math.floor((atPVXAllRound * 3) / 2));
    AddAttribute(panelAttrs, "PVXAllRoundtoDecriticalDamage", atPVXAllRound);

    // console.log(`全能等级：${atPVXAllRound}`);
}
