...
export function GetPanel(attrs) {
    ...
    CalcManaReplenish(attrs, panelAttrs, finalAttrs);
...
function CalcHit(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelPhysicsHitValue = GetAttr(attrs, "atPhysicsHitValue") + GetAttr(attrs, "atAllTypeHitValue");
    ...
    let atPanelNeutralHitValue =
        GetAttr(attrs, "atNeutralHitValue") + GetAttr(attrs, "atMagicHitValue") + GetAttr(attrs, "atAllTypeHitValue");
    ...
    let atPanelPoisonHitValue =
        GetAttr(attrs, "atPoisonHitValue") + GetAttr(attrs, "atMagicHitValue") + GetAttr(attrs, "atAllTypeHitValue");
...
function CalcCriticalDamagePower(attrs, panelAttrs, finalAttrs) {
    ...
    let atPhysicsCriticalDamagePowerPercent = AddAndMultiply(
    ...
    let atPanelPhysicsCriticalDamagePowerPercent =
        ...
        GetAttr(attrs, "atPhysicsCriticalDamagePowerBaseKiloNumRate") / 1024;
    ...
    let atLunarCriticalDamagePowerPercent = AddAndMultiply(
    ...
    let atSolarCriticalDamagePowerPercent = AddAndMultiply(
    ...
    let atNeutralCriticalDamagePowerPercent = AddAndMultiply(
    ...
    let atPoisonCriticalDamagePowerPercent = AddAndMultiply(
...
function CalcOvercome(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelPhysicsOvercomePercent =
        atPanelPhysicsOvercome / (levelConst.fOvercomeParam * levelConst.nLevelCoefficient);
    ...
    let atPanelNeutralOvercomePercent =
        atPanelNeutralOvercome / (levelConst.fOvercomeParam * levelConst.nLevelCoefficient);
    ...
    let atPanelPoisonOvercomePercent =
        atPanelPoisonOvercome / (levelConst.fOvercomeParam * levelConst.nLevelCoefficient);
...
function CalcHaste(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelHastePercent =
        Math.max(
            Math.floor((atPanelHaste / (levelConst.fHasteRate * levelConst.nLevelCoefficient)) * 1024) / 1024,
            atPanelHaste / (levelConst.fHasteRate * levelConst.nLevelCoefficient)
        ) +
        GetAttr(attrs, "atHasteBasePercentAdd") / 1024;
    AddAttribute(panelAttrs, "BaseHastePercent", atPanelHastePercent);
    ...
    let atFinelChannelTimePercent =
        1 - 1 / (1 + Math.max(Math.floor(atPanelHastePercent * 1024) / 1024, Math.min(atPanelHaste / (levelConst.fHasteRate * levelConst.nLevelCoefficient), 0.25)));
...
function CalcParryValue(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelParryValueBase = GetAttr(attrs, "atParryValueBase");
...
function CalcDecriticalDamage(attrs, panelAttrs, finalAttrs) {
    ...
    let atDecriticalPercent =
        atPanelDecritical /
            (atPanelDecritical + levelConst.fDecriticalStrikePowerParam * levelConst.nLevelCoefficient) +
...
function CalcManaReplenish(attrs, panelAttrs, finalAttrs) {
    // console.log(`--->内回<---`);

    //"atManaReplenish","atManaReplenishPercent","atManaReplenishCoefficient","atManaReplenishExt","atSpiritToManaReplenishCof","atSpunkToManaReplenishCof"
    let atPanelManaReplenish =
        GetAttributeConvert(finalAttrs, "atSpunk", attrs, "atSpunkToManaReplenishCof") +
        GetAttributeConvert(finalAttrs, "atSpirit", attrs, "atSpiritToManaReplenishCof") +
        AddAndMultiply(
            GetAttr(attrs, "atManaReplenish"),
            GetAttr(attrs, "atManaReplenishExt"),
            GetAttr(attrs, "atManaReplenishPercent")
        );
    AddAttribute(panelAttrs, "ManaReplenish", atPanelManaReplenish);
    // console.log(`内回等级：${atPanelManaReplenish}`);
    // console.log(`内回百分比：${atPanelManaReplenishPercent}`);
}
