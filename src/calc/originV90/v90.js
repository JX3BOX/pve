...
import { AddCampContribution } from "../campContribution.js"
...
function calculateAttrib({snapshot, mount, setCollection, schema_client = "origin", useHeavy = false, talentCode = [], bodyType = 0, level = 0}) {
    // useHeavy = true;
