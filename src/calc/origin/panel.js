...
function CalcCriticalDamagePower(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelPhysicsCriticalDamagePowerPercent = (levelConst.fPlayerCriticalCof + 1) + atPhysicsCriticalDamagePowerPercent / (levelConst.fCriticalStrikePowerParam * levelConst.nLevelCoefficient) + GetAttr(attrs, "atPhysicsCriticalDamagePowerBaseKiloNumRate") / 1000;
    ...
    let atPanelLunarCriticalDamagePowerPercent = 
        ...
        GetAttr(attrs, "atLunarCriticalDamagePowerBaseKiloNumRate") / 1000;
    ...
    let atPanelSolarCriticalDamagePowerPercent =
        ...
        GetAttr(attrs, "atMagicCriticalDamagePowerBaseKiloNumRate") / 1000 +
        GetAttr(attrs, "atSolarCriticalDamagePowerBaseKiloNumRate") / 1000;
    ...
    let atPanelNeutralCriticalDamagePowerPercent =
        ...
        GetAttr(attrs, "atMagicCriticalDamagePowerBaseKiloNumRate") / 1000 +
        GetAttr(attrs, "atNeutralCriticalDamagePowerBaseKiloNumRate") / 1000;
    ...
    let atPanelPoisonCriticalDamagePowerPercent =
        ...
        GetAttr(attrs, "atMagicCriticalDamagePowerBaseKiloNumRate") / 1000 +
        GetAttr(attrs, "atPoisonCriticalDamagePowerBaseKiloNumRate") / 1000;
...
function CalcPhysicsShield(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelPhysicsShieldFinalPercent = atPanelPhysicsShieldFinal / (levelConst.fPhysicsShieldParam * levelConst.nLevelCoefficient);
...
function CalcMagicShield(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelLunarShieldFinalPercent = atPanelLunarShieldFinal / (levelConst.fMagicShieldParam * levelConst.nLevelCoefficient);
    ...
    let atPanelSolarShieldFinalPercent = atPanelSolarShieldFinal / (levelConst.fMagicShieldParam * levelConst.nLevelCoefficient);
    ...
    let atPanelNeutralShieldFinalPercent = atPanelNeutralShieldFinal / (levelConst.fMagicShieldParam * levelConst.nLevelCoefficient);
    ...
    let atPanelPoisonShieldFinalPercent = atPanelPoisonShieldFinal / (levelConst.fMagicShieldParam * levelConst.nLevelCoefficient);
...
function CalcDodge(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelDodgePercent = atPanelDodge / (levelConst.fDodgeParam * levelConst.nLevelCoefficient);
...
function CalcParry(attrs, panelAttrs, finalAttrs) {
    ...
    let atPanelParryPercent = atPanelParry / (levelConst.fParryParam * levelConst.nLevelCoefficient) + 0.03;
