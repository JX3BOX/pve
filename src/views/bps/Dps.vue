...
import { getDpsList } from "@/service/bps/dps.js";
...
import types from "@/assets/data/bps/dps_types.json";
import User from "@jx3box/jx3box-common/js/user";

import DpsForm from "@/components/bps/dps-form.vue";
export default {
    name: "Dps",
    ...
    methods: {
        ...
        getTypeIcon: function (val) {
            return require(`@/assets/img/bps/dps/${val}.svg`);
        },
        // 编辑
        onEditRow(row) {
...
<style lang="less">
@import "~@/assets/css/bps/dps.less";
