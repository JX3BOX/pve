...
<script>
// 依赖模块
import SingleLayout from "@/layouts/bps/SingleLayout.vue";
import singlebox from "@/components/bps/cms-single";

// 本地数据
import { getPost } from "@/service/bps/post.js";
...
<style lang="less">
@import "~@/assets/css/bps/single.less";
</style>
