                    ...
                    <el-table-column prop="exam_print" label="消耗" width="100" sortable>
                        <template slot-scope="scope">
                            <template v-if="scope.row.ExamPrint && !scope.row.TrainValue">
                                <span class="u-points">
                                    <img src="@/assets/img/bps/recipe/exam_points.png" alt />
                                    {{ scope.row.ExamPrint }}
                                </span>
                            </template>
                            <template v-if="scope.row.TrainCost">
                                <span class="u-points u-train">
                                    <img src="@/assets/img/bps/recipe/train_points.png" alt />
                                    {{ scope.row.TrainCost }}
                                </span>
                            </template>
...
import { getRecipe } from "@/service/bps/node.js";
...
<style lang="less">
@import "~@/assets/css/bps/recipe.less";
</style>
