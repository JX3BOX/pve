        ...
        <div class="v-ladder">
            <div class="m-ladder-header">
                <h3 class="m-ladder-title">
                    <span class="u-title">
                        <img class="u-icon" svg-inline src="@/assets/img/bps/side/rank.svg" /> 门派天梯榜
...
import { getUsers, getRank, getDpsGroup } from "@/service/bps/ladder.js";
import { getBread } from "@/service/bps/helper";
...
<style lang="less">
@import "~@/assets/css/bps/ladder.less";
</style>
