<template>
    <AppLayout class="p-translator" slug="translator" icon="translator" name="簡繁轉換工具" :has-left="false" :has-right="false">
...
import { fetch } from "@/service/tool/api.js";
...
<style lang="less">
@import "~@/assets/css/tool/app/translator.less";
</style>
