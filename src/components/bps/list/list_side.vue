    ...
    <div class="m-list-side">
        ...
        <div class="m-side-links">
            <h3 class="m-side-title" style="border-bottom: none">
                <div class="u-title">
                    <img class="u-icon" svg-inline src="@/assets/img/bps/side/docs.svg" />
                    推荐小册
                </div>
...
<script>
import ladder from "@/assets/data/bps/ladder.json";
import xfmap from "@jx3box/jx3box-data/data/xf/xf.json";
import { __ossMirror, __imgPath, __ossRoot } from "@jx3box/jx3box-common/data/jx3box.json";
import { getMenuGroups } from "@/service/bps/helper.js";
...
<style lang="less">
@import "~@/assets/css/bps/side.less";
</style>
