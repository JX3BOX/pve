<template>
    <div class="m-macro-rank-mini m-macro-rank" v-loading="loading">
        <h3 class="m-side-title">
            <div class="u-title"><img class="u-icon" svg-inline src="@/assets/img/macro/side/rank.svg" />排行榜</div>
...
<script>
import { getOverview, getRank } from "@/service/macro/rank";
...
<style lang="less">
@import "~@/assets/css/macro/rank.less";
</style>
